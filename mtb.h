...
typedef struct movie{
    ...
    struct tm show_date; //<---- predefined structure tm
    seat seats[100];  //<-- array of the structure seat
}movie;
...
void print_basic_screen();
                    ...
                    //Inputing and validation functions
...
void add_questions();  //<--- writes in file only once
...
int* get_seat_number(movie*);
void change_seat_booking_status(int ,char*,struct tm);//seat_no,movie_d,show's_date
